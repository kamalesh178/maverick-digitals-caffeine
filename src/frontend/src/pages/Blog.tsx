import { getAllBlogPosts } from "@/lib/backend";
...
// ─── Category pill colors (dark theme) ───────────────────────────────────────
...
function getCategoryPill(cat: string) {
  return (
    CATEGORY_PILL[cat] ?? "bg-white/10 text-white/70 border border-white/20"
  );
}
        ...
        <div
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLDivElement).style.boxShadow =
              "0 8px 40px rgba(124,58,237,0.25), 0 0 0 1px rgba(124,58,237,0.3)";
...
// ─── Loading skeleton ─────────────────────────────────────────────────────────
function BlogCardSkeleton({ i }: { i: number }) {
  return (
    <div
    ...
    <div style={{ background: "#0a0a0a", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="container mx-auto max-w-6xl px-4 text-center relative z-10">
          ...
          >
            Expert takes on digital marketing, performance ads, and brand
            scaling from the Maverick Digitals team.
          </motion.p>
        </div>
      </section>
      ...
      <div
        style={{
          height: "1px",
          background:
            "linear-gradient(90deg, transparent, rgba(124,58,237,0.3) 30%, rgba(6,182,212,0.3) 70%, transparent)",
        }}
      />
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                >
                  Book a free strategy session and let's map out your growth
                  plan.
                </p>
                <Link to="/contact">
                  <button
