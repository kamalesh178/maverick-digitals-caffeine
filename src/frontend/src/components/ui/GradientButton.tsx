...
const GradientButton = forwardRef<HTMLButtonElement, GradientButtonProps>(
  (
    ...
    const glowStyles = {
      primary: glow
        ? "shadow-[0_0_28px_oklch(0.32_0.09_250/0.45),0_0_56px_oklch(0.32_0.09_250/0.2),0_2px_12px_oklch(0.32_0.09_250/0.35)]"
        : "",
      gold: glow
        ? "shadow-[0_0_28px_oklch(0.72_0.14_65/0.45),0_0_56px_oklch(0.72_0.14_65/0.2),0_2px_12px_oklch(0.72_0.14_65/0.35)]"
        : "",
      outline: "",
      ghost: "",
    };
      ...
      >
        {variant === "primary" && (
          <span
            ...
            style={{
              background:
                "linear-gradient(105deg, transparent 20%, oklch(1 0 0 / 0.18) 50%, transparent 80%)",
